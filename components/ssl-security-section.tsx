...
export function SslSecuritySection() {
  ...
  return (
    <section className="w-full py-24 relative overflow-hidden bg-background border-b border-border/50">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col items-start text-left">
            ...
            <p className="text-muted-foreground text-[15px] leading-relaxed mb-8 max-w-md">
              Enterprise-grade security shouldn&apos;t require complex configurations. We automatically provision and renew SSL certificates for all your deployments and custom domains. Secure connections, fully out of the box.
            </p>
          ...
          {/* Right: The Browser Mockup */}
          <div className="relative w-full flex items-center justify-center">
            {/* Glow behind */}
            <div className="absolute inset-0 bg-emerald-500/10 blur-[100px] rounded-full pointer-events-none -z-10" />

            {/* Browser Window */}
            <div className="w-full max-w-[450px] bg-[#09090b] border border-border/50 shadow-2xl rounded-xl overflow-hidden flex flex-col">
